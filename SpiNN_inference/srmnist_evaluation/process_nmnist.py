"""
This module handles the streaming of live events acquired from DAVIS346 DVS to the SpiNNaker
...
from digit_recognition.SpiNN_inference.helpers import receiver_nmnist_srmnist, injector_srmnist

delta_t = 10_000 # Event collection window in microseconds

inject_cfg = InjectorConfig()
receiver_cfg = ReceiverConfig()

# Initialize SpiNNaker communication interfaces
spinn_injector = injector_srmnist.Injector_SRMNIST(Injector_conf=inject_cfg)
spinn_receiver = receiver_nmnist_srmnist.Receiver_SRMNIST(receiver_conf=receiver_cfg)
